...
//+kubebuilder:rbac:groups=free5gc.nephio.org,resources=imageconfigs,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=free5gc.nephio.org,resources=imageconfigs/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=free5gc.nephio.org,resources=imageconfigs/finalizers,verbs=update
...
func (r *ImageConfigReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&free5gcv1alpha1.ImageConfig{}).
		Complete(r)
}
